    ...
    encode: function (s) {
      ...
      if (B64.ie) {
        ...
        while (++position < len) {
          ...
          result.push(
            B64.alphabet.charAt(enc[0]),
            B64.alphabet.charAt(enc[1]),
            B64.alphabet.charAt(enc[2]),
            B64.alphabet.charAt(enc[3])
          );
        }
        return result.join("");
      } else {
